        ...
        <div class="col-lg-5 col-lg-offset-5">
            <div class="input-group">
                ...
                <table>
                        ...
                        <tr>
                                <td><?php echo form_label('New email address', $email['id']); ?></br>
                                <?php echo form_input($email); ?></br>
                                <font style="color: red;"><?php echo form_error($email['name']); ?><?php echo isset($errors[$email['name']])?$errors[$email['name']]:''; ?></font></td>
                        </tr>
                </table>
                </br>
